...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
                    ...
                    addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (!task.isSuccessful()) {
                                Toast.makeText(LoginActivity.this, getResources().getString(R.string.messgae_login_fail),
                                        Toast.LENGTH_SHORT).show();
                                mPasswordView.setError(getString(R.string.messgae_login_fail));
                                mPasswordView.requestFocus();
                            } else {
                                Toast.makeText(LoginActivity.this, getResources().getString(R.string.messgae_login_success),
                                        Toast.LENGTH_SHORT).show();
                                finish();
    ...
    public void onRegisterListener(View v){
        startActivity(new Intent(v.getContext(),RegisterActivity.class));
    }

    public void onForgotPasswordListener(View v){
